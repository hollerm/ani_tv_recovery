...
def imsave(fname,img,format=None,rg=[]): #rg defines grayscale boundary values. Choosing rg=[] uses [img.min(),img.max()]
...
class nfun(object):
    ...
    def __init__(self,ntype,npar=1.0,mshift=0.0,vdims=(),vecweights = False,mask=False,eps=0.1,delta=1.0,l1eps_par=10e-05):
